...
object ExampleJson {
  ...
  case class Top(query: Query)
  // TODO: created should be a DateTime
  case class Query(count: Int, created: String, lang: String, diagnostics: Diagnostics, results: Results)
  case class Results(channel: Channel)
  case class Channel(title: String, link: String, description: String, language: String,
                     lastBuildDate: DateTime, ttl: Int, location: Location, units: Units, wind: Wind,
                     atmosphere: Atmosphere, astronomy: Astronomy, image: Image, item: Item)
  case class Item(title: String, lat: Double, long: Double, link: String,
                  pubDate: DateTime, condition: Condition, description: String,
                  forecast: List[Forecast], guid: Guid)
  case class Astronomy(sunrise: DateTime, sunset: DateTime)
  case class Image(title: String, width: Int, height: Int, link: String, url: String)
  ...
  val testResults = s"""{ "channel": $testChannel }"""
  ...
  val megaTest = s"""{ "query": $testQuery }"""
